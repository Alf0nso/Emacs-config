...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "transmission" '("define-transmission-" "download>?" "eta>=?" "file-have>?" "percent-done>?" "progress>?" "ratio>?" "size" "transmission-" "upload>?")))
