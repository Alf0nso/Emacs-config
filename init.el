...
(custom-set-variables
 ...
 '(package-selected-packages
   '(graphviz-dot-mode elpy live-py-mode exwm ytdl haskell-mode treemacs-icons-dired dired-subtree dired+ ein sparql-mode pdf-tools auto-complete auctex use-package smex pyvenv org-bullets gradle-mode which-key helm gnu-elpa-keyring-update)))
(custom-set-faces
